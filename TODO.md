...
CNAME auf den GitHub-User (nicht auf die Custom-Domain):

```
CNAME  www  moellenbeck.github.io.
```
...
Erwartet: Die vier `185.199.108-111.153` IPs bzw. `moellenbeck.github.io`.
...
```
gh api -X PUT repos/moellenbeck/moellenbeck-digital/pages -F https_enforced=true
```
...
- Repo: https://github.com/moellenbeck/moellenbeck-digital
- Pages (vorläufig, vor DNS): https://moellenbeck.github.io/moellenbeck-digital/
